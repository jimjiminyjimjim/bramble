...
export const Testimonial = () => {
  return (
    <section className="container relative py-8 lg:py-24">
      <div
          ...
          <SwiperSlide>
            <div className="text-center">
              ...
              <p className="mt-4 inline-block max-w-[600px] text-center">
                WrapAI is a game-changer! The voice commands and personalized
                insights from James, the virtual assistant, have boosted my
                productivity. It's like having a personal AI assistant tailored
                just for me!
              </p>
              <p className="mt-8 text-lg font-medium">Mark Thompson</p>
              <p className="text-sm text-base-content/70">
                (Marketing Manager at Layerway)
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="text-center">
              ...
              <p className="mt-4 inline-block max-w-[600px] text-center">
                As a UX designer, I appreciate the user-friendly interface of
                the AI app. It seamlessly integrates with our design processes,
                and the natural language processing feature makes interactions
                smooth and intuitive.
              </p>
              <p className="mt-8 text-lg font-medium">Sarah Johnson</p>
              <p className="text-sm text-base-content/70">
                (UX Designer at MyComp)
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="text-center">
              ...
              <p className="mt-4 inline-block max-w-[600px] text-center">
                I've integrated Landrick's AI capabilities into our mobile app
                effortlessly. The cross-platform compatibility and robust
                machine learning tools make it a developer's dream. Highly
                recommend for anyone working in the tech space.
              </p>
              <p className="mt-8 text-lg font-medium">Alex Chen</p>
              <p className="text-sm text-base-content/70">
                (Mobile Developer at Android)
              </p>
            </div>
          </SwiperSlide>
        </Swiper>
